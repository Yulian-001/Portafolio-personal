                    ...
                    {prof.studies.map(({ src, alt, info, spinnerColor, title }, index) => {
                        ...
                        return (
                            ...
                            <div
                                ...
                                <div className={`
                                        absolute md:w-xl md:translate-y-22 px-4 py-6 bg-black/95 border border-white/20 text-white text-xs md:text-lg rounded-xl shadow-xl transition-all duration-300 z-30
